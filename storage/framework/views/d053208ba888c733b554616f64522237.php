<div>
    ...
    <section class="hero">
        <div class="hero-bg">
            <img src="<?php echo e(asset('images/hero-salon.webp')); ?>" alt="Alfa Beauty Professional Salon" class="hero-image" fetchpriority="high">
        </div>
        <div class="hero-content">
            <h1 class="hero-title">
                <?php echo e(__('home.hero_title_1')); ?><br>
                <em><?php echo e(__('home.hero_title_2')); ?></em>
            </h1>
            <p class="hero-tagline"><?php echo e(__('home.hero_tagline')); ?></p>
            <p class="hero-tagline-bold"><?php echo e(__('home.hero_tagline_bold')); ?></p>
        </div>
        <!-- Scroll Indicator - V3 Spec: No CTA in hero for premium feel -->
        <div class="hero-scroll">
            <span class="scroll-indicator"><?php echo e(__('home.scroll')); ?></span>
        </div>
    </section>
    ...
    <section class="products" id="products">
        ...
        <div class="section-header">
            <div>
                <h2 class="section-title"><?php echo e(__('home.best_sellers')); ?></h2>
                <p class="section-subtitle"><?php echo e(__('home.curated_results')); ?></p>
            </div>
            <a href="<?php echo e(route('products.index')); ?>" class="btn"><?php echo e(__('general.view_all')); ?> →</a>
        </div>
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-12375145-0', null);
...
?>
    ...
    <section class="brands" id="brands">
        <div class="brands-header">
            <h2 class="section-title"><?php echo e(__('home.our_brands')); ?></h2>
        </div>
        <div class="brands-list">
            ...
            <a href="<?php echo e(route('brands.show', $brand->slug)); ?>" class="brand-item" data-index="<?php echo e(str_pad($index + 1, 2, '0', STR_PAD_LEFT)); ?>">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($brand->logo_url): ?>
                    <div class="brand-logo-display">
                        <img src="<?php echo e(url($brand->logo_url)); ?>" alt="<?php echo e($brand->name); ?>" loading="lazy">
                    </div>
                <?php else: ?>
                    <span class="brand-name"><?php echo e($brand->name); ?></span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <span class="brand-meta"><?php echo e($brand->origin_country); ?> · <?php echo e($brand->is_own_brand ? __('home.our_brand') : __('home.partner')); ?></span>
                <div class="brand-hover-info">
                    <div class="brand-hover-stat">
                        <span class="hover-stat-num"><?php echo e($brand->product_count); ?></span>
                        <span class="hover-stat-label"><?php echo e(__('home.products_count')); ?></span>
                    </div>
                    <div class="brand-hover-stat">
                        <span class="hover-stat-num"><?php echo e(number_format($brand->total_stock)); ?></span>
                        <span class="hover-stat-label"><?php echo e(__('home.available')); ?></span>
                    </div>
                    <div class="brand-hover-stat">
                        <span class="hover-stat-num"><?php echo e($brand->origin_country); ?></span>
                        <span class="hover-stat-label"><?php echo e(__('home.origin')); ?></span>
                    </div>
                </div>
            </a>
    ...
    <section class="company" id="about">
        <div class="company-visual">
            <img src="<?php echo e(asset('images/brands-interior.webp')); ?>" alt="Alfa Beauty Facility" class="company-image" loading="lazy">
            
            <!-- Desktop Headline: Structural Split -->
            <div class="company-headline-desktop">
                <span class="text-white"><?php echo e(__('home.trusted_partner')); ?></span>
                <span class="text-black"><?php echo e(__('home.partner_terpercaya')); ?></span>
            </div>

            <!-- Mobile Headline: Simple Stack -->
            <h2 class="company-headline-mobile"><?php echo e(__('home.trusted_partner')); ?> <?php echo e(__('home.partner_terpercaya')); ?></h2>
        </div>
        <div class="company-details">
            <p class="company-desc"><?php echo e(__('home.company_desc')); ?></p>
            <div class="company-stats">
                <div class="stat"><span class="stat-num">15+</span><span class="stat-txt"><?php echo e(__('home.years')); ?></span></div>
                <div class="stat"><span class="stat-num">3,000+</span><span class="stat-txt"><?php echo e(__('home.salons')); ?></span></div>
                <div class="stat"><span class="stat-num">50+</span><span class="stat-txt"><?php echo e(__('home.cities')); ?></span></div>
            </div>
        </div>
    </section>
    ...
    <section class="cta-contact">
        <div class="cta-contact-container">
            <h2 class="cta-contact-title"><?php echo e(__('home.get_in_touch')); ?></h2>
            <p class="cta-contact-subtitle"><?php echo e(__('home.contact_subtitle')); ?></p>
            
            <form class="cta-contact-form" action="#" method="POST">
                <?php echo csrf_field(); ?>
                <div class="form-row">
                    <div class="form-group">
                        <label for="contact-name"><?php echo e(__('checkout.name')); ?></label>
                        <input type="text" id="contact-name" name="name" placeholder="<?php echo e(__('checkout.name')); ?>">
                    </div>
                    <div class="form-group">
                ...
                <div class="form-group">
                    <label for="contact-phone"><?php echo e(__('checkout.phone')); ?></label>
                    <input type="tel" id="contact-phone" name="phone" placeholder="<?php echo e(__('checkout.phone')); ?>">
                </div>
                ...
                <button type="submit" class="cta-contact-btn"><?php echo e(__('home.send_message')); ?></button>
            </form>
        </div>
    </section>
</div>
<?php /**PATH C:\Users\VCTUS\Documents\rid\27\app\resources\views/livewire/home-page.blade.php ENDPATH**/ ?>