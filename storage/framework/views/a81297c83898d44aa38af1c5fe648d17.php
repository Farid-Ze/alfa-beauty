<div class="product-reviews">
    ...
    <div class="reviews-summary">
        <div class="rating-overview">
            <div class="rating-big">
                ...
                <div class="rating-stars">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 1; $i <= 5; $i++): ?>
                        <svg width="20" height="20" fill="<?php echo e($i <= round($averageRating) ? 'var(--gold)' : 'none'); ?>"
                            stroke="var(--gold)" viewBox="0 0 24 24">
            ...
            <p class="total-reviews"><?php echo e($totalReviews); ?> <?php echo e(__('reviews.reviews_count')); ?></p>
        </div>

        <div class="rating-distribution">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $distribution; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stars => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="rating-bar">
                    <span class="stars-label"><?php echo e($stars); ?></span>
                    ...
                    <span class="bar-count"><?php echo e($data['count']); ?></span>
                </div>
    ...
    <div class="reviews-list">
            ...
            <div class="review-card">
                <div class="review-header">
                    <div class="reviewer-info">
                        <span class="reviewer-name"><?php echo e($review->user?->name ?? 'Anonim'); ?></span>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($review->is_verified): ?>
                            <span class="verified-badge">
                                ...
                                <?php echo e(__('reviews.verified_buyer')); ?>
                    ...
                    <div class="review-meta">
                        <div class="review-stars">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 1; $i <= 5; $i++): ?>
                                <svg width="14" height="14" fill="<?php echo e($i <= $review->rating ? 'var(--gold)' : 'none'); ?>"
                                    stroke="var(--gold)" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                        d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
                                </svg>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="no-reviews">
                ...
                <p><?php echo e(__('reviews.no_reviews_yet')); ?></p>
                <span class="hint"><?php echo e(__('reviews.be_first')); ?></span>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasMore): ?>
        <div class="load-more">
            <button wire:click="loadMore" class="btn btn-secondary">
                <?php echo e(__('reviews.load_more')); ?>
...
</div><?php /**PATH C:\Users\VCTUS\Documents\rid\27\app\resources\views/livewire/product-reviews.blade.php ENDPATH**/ ?>