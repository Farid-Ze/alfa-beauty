...
<head>
    ...
    <title>500 - {{ __('errors.server_error') }} | Alfa Beauty</title>
...
<body>
    ...
    <main class="error-main">
        <div class="error-container">
            ...
            <h1 class="error-title">{{ __('errors.server_error') }}</h1>
            <p class="error-message">{{ __('errors.server_error_desc') }}</p>
            <div class="error-actions">
                ...
                <a href="https://wa.me/{{ config('services.whatsapp.business_number') }}" target="_blank" class="btn btn-secondary">
