...
<head>
    ...
    <title>419 - {{ __('errors.session_expired') }} | Alfa Beauty</title>
...
<body>
    ...
    <main class="error-main">
        <div class="error-container">
            ...
            <h1 class="error-title">{{ __('errors.session_expired') }}</h1>
            <p class="error-message">{{ __('errors.session_expired_desc') }}</p>
