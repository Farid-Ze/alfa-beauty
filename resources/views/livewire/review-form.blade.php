            ...
            @else
                <form wire:submit="submit" class="review-form">
                        ...
                        <div class="stars-input">
                            @for($i = 1; $i <= 5; $i++)
                                <button type="button" wire:click="setRating({{ $i }})"
                                    class="star-btn {{ $rating >= $i ? 'active' : '' }}" aria-label="Rate {{ $i }} star">
                                    <svg width="24" height="24" fill="{{ $rating >= $i ? 'var(--gold)' : 'none' }}" stroke="var(--gold)"
                                        viewBox="0 0 24 24">
                    ...
                    <div class="form-group">
                        <label class="form-label">{{ __('reviews.title') }} <span
                                class="optional">({{ __('reviews.optional') }})</span></label>
                        <input type="text" wire:model="title" placeholder="{{ __('reviews.title_placeholder') }}"
                            class="form-input">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea wire:model="content" rows="4" placeholder="{{ __('reviews.content_placeholder') }}"
